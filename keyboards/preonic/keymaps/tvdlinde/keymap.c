...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_MAIN] = LAYOUT_ortho_5x12(  
		...
		OSM(MOD_LALT),  TD(DANCE_4),    TG(_RSE),      TD(DANCE_2),  LALT(KC_BSPC),   KC_ENT,          KC_TAB,           KC_SPACE,       TD(DANCE_3),    TG(_LWR),     OSM(MOD_LCTL), OSM(MOD_LGUI)),
	[_RSE] = LAYOUT_ortho_5x12(
		KC_EXLM,        KC_AT,          KC_HASH,       KC_DLR,       KC_PERC,  LSFT(KC_GRAVE),         KC_DEL,           KC_CIRC,        KC_AMPR,        KC_ASTR,      KC_LPRN,       KC_RPRN, 
		KC_TRNS,        KC_TRNS,        KC_LCBR,       KC_RCBR,      KC_TRNS,  KC_PLUS,                KC_UNDS,          KC_GRAVE,       KC_7,           KC_8,         KC_9,          KC_SCLN, 
		KC_TRNS,        KC_MINUS,       KC_LPRN,       KC_RPRN,      KC_DLR,   KC_PIPE,                KC_DQUO,          KC_MINUS,       KC_4,           KC_5,         KC_6,          KC_TRNS, 
		KC_TRNS,        KC_TRNS,        KC_LBRC,       KC_RBRC,      KC_TRNS,  LALT(KC_BSLASH),        LALT(KC_PIPE),    KC_TRNS,        KC_1,           KC_2,         KC_3,          KC_TRNS, 
		KC_TRNS,        KC_TRNS,        KC_TRNS,       KC_TRNS,      KC_TRNS,  KC_BSPC,                KC_TRNS,          KC_BSPC,        KC_0,           TO(_MAIN),    KC_TRNS,       KC_TRNS),
	[_LWR] = LAYOUT_ortho_5x12(
		KC_TRNS,        KC_TRNS,        KC_TRNS,       KC_TRNS,      KC_TRNS,  KC_TRNS,                KC_DEL,           KC_TRNS,        KC_HOME,        KC_PGUP,      KC_END,        KC_TRNS,
		...
		MO(_PGUPDN),    KC_TRNS,        TO(_MAIN),     KC_TRNS,      KC_TRNS,  KC_TRNS,                KC_DEL,           KC_BSPC,        KC_TRNS,        KC_TRNS,      KC_TRNS,       KC_TRNS),
