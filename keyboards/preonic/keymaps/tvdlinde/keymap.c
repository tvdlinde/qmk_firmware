...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BLU] = LAYOUT_ortho_5x12(
       KC_TRNS,             KC_F1,               KC_F2,         KC_F3,           KC_F4,         KC_F5,             KC_F6,             KC_F7,            KC_F8,          KC_F9,          KC_F10,              KC_PLUS,
    ...
    [_GRN] = LAYOUT_ortho_5x12(
       KC_TRNS,             KC_TRNS,             KC_TRNS,       KC_TRNS,         KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,          KC_HOME,        KC_PGUP,        KC_END,              KC_PLUS,
    ...
    [_MEH] = LAYOUT_ortho_5x12(
       ...
       MEH(KC_TAB),         KC_TRNS,             MEH(KC_W),     MEH(KC_F),       MEH(KC_P),     KC_TRNS,           KC_TRNS,           MEH(KC_L),        MEH(KC_U),      MEH(KC_Y),      KC_TRNS,             KC_TRNS,
       ...
       MEH(KC_DEL),         LGUI_T(MEH(KC_F12)), KC_TRNS,       MEH(KC_F13),     MEH(KC_UP),    KC_TRNS,           KC_TRNS,           MEH(KC_DOWN),     MEH(KC_ESCAPE), KC_TRNS,        LGUI_T(MEH(KC_F12)), MEH(KC_ENTER)),
};
