...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BLU] = LAYOUT_ortho_5x12(
       ...
       LALT(KC_BSLASH),       KC_TRNS,             KC_TRNS,       KC_LCBR,         KC_RCBR,       KC_TRNS,           KC_GRAVE,          KC_P7,            KC_P8,          KC_P9,          KC_BSLASH,           KC_TRNS,
       ...
       KC_F3,                 KC_TRNS,             KC_TRNS,       LALT(KC_DEL),    LALT(KC_PIPE), LM(_RED,MOD_MEH),  KC_TRNS,           KC_TRNS,          KC_P0,          KC_BSPC,        KC_PDOT,             KC_TRNS),
