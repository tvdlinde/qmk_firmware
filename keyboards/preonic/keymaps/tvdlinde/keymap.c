...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT_ortho_5x12(  
       ...
       KC_Z,           KC_X,           TD(DANCE_1),   KC_D,         KC_V,            KC_GRAVE,           KC_ESCAPE,          KC_K,             KC_H,           KC_COMMA,     KC_DOT,        KC_SLASH, 
    ...
    [_MEH] = LAYOUT_ortho_5x12(
       ...
       KC_TRNS,        KC_TRNS,        KC_TRNS,       KC_TRNS,      KC_TRNS,         MEH(KC_F12),        MEH(KC_ESCAPE),     KC_TRNS,          KC_TRNS,        KC_TRNS,      KC_TRNS,       KC_TRNS, 
