...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT_ortho_5x12(  
       ...
       KC_TAB,              LGUI_T(KC_F12),      OSM(MOD_LCTL), KC_EQUAL,        TD(DANCE_2),   LT(_GRN,KC_SPACE), LT(_BLU,KC_SPACE), TD(DANCE_3),      KC_MINUS,       OSM(MOD_RALT),  RGUI_T(KC_F12),      KC_ENTER),
    ...
    [_MEH] = LAYOUT_ortho_5x12(
       ...
       KC_TRNS,             KC_TRNS,             KC_TRNS,       KC_TRNS,         KC_TRNS,       KC_LGUI,           KC_LGUI,           KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,             KC_TRNS, 
       MEH(KC_TAB),         LGUI_T(MEH(KC_F12)), KC_TRNS,       MEH(KC_F13),     MEH(KC_UP),    KC_TRNS,           KC_TRNS,           MEH(KC_DOWN),     MEH(KC_F16),    KC_TRNS,        LGUI_T(MEH(KC_F12)), MEH(KC_ENTER)),
};
