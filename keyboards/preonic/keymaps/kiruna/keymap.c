...
void dance_2_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case SINGLE_HOLD: register_code16(LSFT(RALT(KC_6))); break;
...
void dance_2_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case SINGLE_HOLD: unregister_code16(LSFT(RALT(KC_6))); break;
...
void dance_3_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case DOUBLE_TAP: register_code16(LSFT(RALT(KC_6)));s break;
        case DOUBLE_SINGLE_TAP: tap_code16(LSFT(RALT(KC_6)));s break;
    }
}
...
void dance_3_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case DOUBLE_TAP: unregister_code16(LSFT(RALT(KC_6)));s break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LSFT(RALT(KC_6)));s break;
    }
    dance_state.step = 0;
}
