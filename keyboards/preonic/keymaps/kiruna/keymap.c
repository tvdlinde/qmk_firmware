...
void dance_3_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case DOUBLE_TAP: register_code16(LSFT(RALT(KC_6))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LSFT(RALT(KC_6))); break;
    }
}
...
void dance_3_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        ...
        case DOUBLE_TAP: unregister_code16(LSFT(RALT(KC_6))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LSFT(RALT(KC_6))); break;
    }
    dance_state.step = 0;
}
